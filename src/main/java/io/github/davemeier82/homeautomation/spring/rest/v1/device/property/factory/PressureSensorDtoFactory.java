...
import io.github.davemeier82.homeautomation.spring.rest.v1.device.property.dto.PressureSensorPropertyDto;
...
public class PressureSensorDtoFactory implements DevicePropertyDtoFactory {

  private final DevicePropertyValueRepository devicePropertyValueRepository;

  public PressureSensorDtoFactory(DevicePropertyValueRepository devicePropertyValueRepository) {
  ...
  public DevicePropertyDto map(DeviceProperty deviceProperty) {
    Optional<DataWithTimestamp<Float>> pressure = devicePropertyValueRepository.findLatestValue(deviceProperty.getId(), PRESSURE, Float.class);
    return new PressureSensorPropertyDto(
        ...
        getValueOrNull(pressure),
        getTimestampOrNull(pressure)
    );
  }
