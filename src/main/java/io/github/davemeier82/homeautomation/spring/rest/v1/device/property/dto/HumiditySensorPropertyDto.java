...
public class HumiditySensorPropertyDto extends DevicePropertyDto {
  private final Float relativeHumidityInPercent;
  private final OffsetDateTime lastUpdated;

  public HumiditySensorPropertyDto(String id,
                                   String type,
                                   String displayName,
