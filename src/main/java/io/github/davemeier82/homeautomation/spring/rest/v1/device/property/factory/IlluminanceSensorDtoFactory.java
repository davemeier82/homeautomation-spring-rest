...
import io.github.davemeier82.homeautomation.spring.rest.v1.device.property.dto.IlluminanceSensorPropertyDto;
...
public class IlluminanceSensorDtoFactory implements DevicePropertyDtoFactory {

  private final DevicePropertyValueRepository devicePropertyValueRepository;

  public IlluminanceSensorDtoFactory(DevicePropertyValueRepository devicePropertyValueRepository) {
  ...
  public DevicePropertyDto map(DeviceProperty deviceProperty) {
    Optional<DataWithTimestamp<Integer>> illuminance = devicePropertyValueRepository.findLatestValue(deviceProperty.getId(), ILLUMINANCE, Integer.class);
    return new IlluminanceSensorPropertyDto(
        ...
        getValueOrNull(illuminance),
        getTimestampOrNull(illuminance)
    );
  }
